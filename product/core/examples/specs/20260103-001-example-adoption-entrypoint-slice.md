...
## Allowed Edits
- `README.md`
- `.dev_sop/core/guides/phase-aware-workflow.md`
- `.dev_sop/core/guides/phase-aware-canonical-example.md`

## Disallowed Edits
- `AGENTS.md` workflow semantics
- namespace roots under `.dev_sop/`
...
Record the resulting long-task example pattern in a project-generated fact file under `.dev_sop/project-facts/*` as a `task_pattern` or `phase_lesson` if it remains a stable reusable adoption reference.
