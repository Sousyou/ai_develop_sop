...
## Expected Outputs
- one lifecycle guide under `.dev_sop/doc/guides/`
...
- `.dev_sop/doc/templates/task-spec-template.md`
...
If this slice establishes a reusable boundary rule for future phase-aware work, record it as a `phase_lesson` or `facts_update` in `.dev_sop/doc/facts/project-scope.md`. Otherwise keep delivery notes local.
