...
This is a project-facing release record. Store the filled artifact in the project's chosen release docs location, for example `docs/releases/REL-YYYYMMDD-NNN.md` or another release-docs path the project already uses.
