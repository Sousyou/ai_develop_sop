...
If the repository uses `.dev_sop/control/*`, completion reporting should state whether `.dev_sop/skill/session-closeout.md` was applied and what, if anything, was updated.
