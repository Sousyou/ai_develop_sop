...
These are starter-owned reference cases for the SOP package.
They are not live project facts.
...
See `.dev_sop/core/guides/phase-aware-canonical-example.md` and `.dev_sop/core/examples/specs/20260103-001-example-adoption-entrypoint-slice.md`.
For copyable plan artifacts, also see `.dev_sop/core/guides/phase-aware-example-main-plan.md` and `.dev_sop/core/guides/phase-aware-example-sub-plan.md`.
...
See `.dev_sop/core/examples/specs/20260104-001-example-first-copied-project-quickstart.md`.
