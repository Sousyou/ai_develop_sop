...
- the active task spec in `.dev_sop/doc/specs/*`
- optional `.dev_sop/doc/facts/*`
...
- `.dev_sop/doc/facts/*` with `decision_rationale` only if the task froze a durable project-level choice and the rationale is reusable
