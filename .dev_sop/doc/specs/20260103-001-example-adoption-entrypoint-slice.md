...
## Allowed Edits
- `README.md`
- `.dev_sop/doc/guides/phase-aware-workflow.md`
...
Record the resulting long-task example pattern in `.dev_sop/doc/facts/golden-cases.md` as a `task_pattern` or `phase_lesson` if it remains a stable reusable adoption reference.
