...
Follow `.dev_sop/doc/specs/README.md` for spec refinement, splitting, and lifecycle conventions.
Use `.dev_sop/doc/guides/task-lifecycle-and-escalation.md` when the handoff needs explicit repair, rollback, replan, or escalation rules.
