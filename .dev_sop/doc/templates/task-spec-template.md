...
Store task specs in `.dev_sop/doc/specs/` and name them `YYYYMMDD-NNN-task-slug.md`.
...
If the repository uses `.dev_sop/control/*`, use `.dev_sop/skill/session-closeout.md` to decide whether `.dev_sop/control/CURRENT.md`, `.dev_sop/control/DOC_MAP.md`, facts, or skills need updates.
Suggested labels:
- `facts_update`
- `skill_promotion`
- `decision_rationale`
