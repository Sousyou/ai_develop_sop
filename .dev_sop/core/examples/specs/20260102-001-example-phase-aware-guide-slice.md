...
## Expected Outputs
- one lifecycle guide under `.dev_sop/core/guides/`
...
If this slice establishes a reusable boundary rule for future phase-aware work, record it as a `phase_lesson` or `facts_update` in an appropriate file under `.dev_sop/project-facts/*`. Otherwise keep delivery notes local.
