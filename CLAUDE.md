...
This repository uses `CLAUDE.md` as the Claude Code entry adapter.

## Claude Code Reading Order

1. Read `AGENTS.md` for the shared source-repo entry contract.
2. Continue through `facts/*` and `product/*` in the order described there.
